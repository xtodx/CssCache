 ...
 * by `ScssParser` into a syntax tree, then it is compiled into another tree
 * representing the CSS structure by `scssc`. The CSS tree is fed into a
 * formatter, like `ScssFormatter` which then outputs CSS as a string.
 *
 ...
 * time.
 *
 * The `ScssParser` class is only concerned with parsing its input.
 *
 * The `ScssFormatter` takes a CSS tree, and dumps it to a formatted string,
...
use system\modules\Scss\ScssFormatter;
use system\modules\Scss\ScssFormatterCompressed;
use system\modules\Scss\ScssFormatterNested;
use system\modules\Scss\ScssParser;
use system\modules\Scss\ScssServer;
...
class Scss
{
    ...
    protected $formatter = "system\modules\Scss\ScssFormatterNested";
    ...
    protected function injectVariables(array $args)
    {
        ...
        $parser = new ScssParser(__METHOD__, false);
